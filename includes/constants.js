...
const SEEDS_DATASET = "ga4_transformation_seed"; /* the database containing the GA4 BigQuery data mapping seeds such as source categories */
const STAGING_DATASET = "ga4_transformation_staging";
const INTERMEDIATE_DATASET = "ga4_transformation_intermediate";
const OUTPUT_DATASET = "ga4_transformation_output";
const DASHBOARDS_DATASET = "ga4_transformation_dashboards";
